...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
    ...
    return (
        ...
        <div className="lg:pl-64">
            {/* Top bar */}
            <div className="fixed top-0 left-0 right-0 z-40 bg-white dark:bg-dark-800 shadow-sm border-b border-gray-200 dark:border-dark-700 lg:left-64 lg:right-0 lg:w-[calc(100%-16rem)] lg:pl-0">
